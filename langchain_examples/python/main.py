...
if __name__ == '__main__':
    ...
    # All the chains will run one by one independently. Can test any one of them individually. 
    ...
    # Case 2 (getBalance):
    agent_chain.run("Balance in account 8fbqVvpK3Dj7fdP2c8JJhtD7Zy3n9qtwAeGfbkgPu625 have?")
    # Expected response: The balance of account 8fbqVvpK3Dj7fdP2c8JJhtD7Zy3n9qtwAeGfbkgPu625 is <Numerical value>.
    
    # Case 3 (getAccountInfo): 
